def format_name(f_name,l_name,format):
    # here this line below represents the documentation of the current fucntion. 
    """This function takes first_name and last_name and return the formatted output of selected format type."""
    if format=="lower":
        f_name = f_name.lower()
        l_name = l_name.lower()
    elif format=="upper":
